...
ArmorInfo.Glossary = glossary

ArmorInfo.Starters = TableFunctions.Filter(ArmorInfo.Glossary, function(armor: Armor)
	return armor.Category == "Starter"
end)

function ArmorInfo.GetRandomStarter()
	return ArmorInfo.Starters[math.random(1, #ArmorInfo.Starters)]
end
